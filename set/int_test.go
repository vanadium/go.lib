...
func TestInt(t *testing.T) {
	...
	// Test set difference.
	{
		...
		s3 := Int.FromSlice(slice[1:])
		s4 := Int.FromSlice(slice)
		Int.Difference(s3, s4)
		...
		s5 := Int.FromSlice(slice[1:])
		s6 := Int.FromSlice(slice[:1])
		Int.Difference(s5, s6)
		...
		s7 := Int.FromSlice(slice)
		s8 := Int.FromSlice(slice)
		Int.Difference(s7, s8)
		for i, want := range []bool{false, false} {
