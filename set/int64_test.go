...
func TestInt64(t *testing.T) {
	...
	{
		s1 := Int64.FromSlice(slice)
		s2 := Int64.FromSlice(slice[1:])
		Int64.Difference(s1, s2)
		...
		s3 := Int64.FromSlice(slice[1:])
		s4 := Int64.FromSlice(slice)
		Int64.Difference(s3, s4)
		...
		s5 := Int64.FromSlice(slice[1:])
		s6 := Int64.FromSlice(slice[:1])
		Int64.Difference(s5, s6)
		...
		s7 := Int64.FromSlice(slice)
		s8 := Int64.FromSlice(slice)
		Int64.Difference(s7, s8)
		for i, want := range []bool{false, false} {
