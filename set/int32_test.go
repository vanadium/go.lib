...
func TestInt32(t *testing.T) {
	...
	{
		s1 := Int32.FromSlice(slice)
		s2 := Int32.FromSlice(slice[1:])
		Int32.Difference(s1, s2)
		...
		s3 := Int32.FromSlice(slice[1:])
		s4 := Int32.FromSlice(slice)
		Int32.Difference(s3, s4)
		...
		s5 := Int32.FromSlice(slice[1:])
		s6 := Int32.FromSlice(slice[:1])
		Int32.Difference(s5, s6)
		...
		s7 := Int32.FromSlice(slice)
		s8 := Int32.FromSlice(slice)
		Int32.Difference(s7, s8)
		for i, want := range []bool{false, false} {
