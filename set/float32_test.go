...
func TestFloat32(t *testing.T) {
	...
	{
		s1 := Float32.FromSlice(slice)
		s2 := Float32.FromSlice(slice[1:])
		Float32.Difference(s1, s2)
		...
		s3 := Float32.FromSlice(slice[1:])
		s4 := Float32.FromSlice(slice)
		Float32.Difference(s3, s4)
		...
		s5 := Float32.FromSlice(slice[1:])
		s6 := Float32.FromSlice(slice[:1])
		Float32.Difference(s5, s6)
		...
		s7 := Float32.FromSlice(slice)
		s8 := Float32.FromSlice(slice)
		Float32.Difference(s7, s8)
		for i, want := range []bool{false, false} {
