...
func TestInt8(t *testing.T) {
	...
	{
		s1 := Int8.FromSlice(slice)
		s2 := Int8.FromSlice(slice[1:])
		Int8.Difference(s1, s2)
		...
		s3 := Int8.FromSlice(slice[1:])
		s4 := Int8.FromSlice(slice)
		Int8.Difference(s3, s4)
		...
		s5 := Int8.FromSlice(slice[1:])
		s6 := Int8.FromSlice(slice[:1])
		Int8.Difference(s5, s6)
		...
		s7 := Int8.FromSlice(slice)
		s8 := Int8.FromSlice(slice)
		Int8.Difference(s7, s8)
		for i, want := range []bool{false, false} {
