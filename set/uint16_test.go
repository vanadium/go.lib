...
func TestUint16(t *testing.T) {
	...
	{
		s1 := Uint16.FromSlice(slice)
		s2 := Uint16.FromSlice(slice[1:])
		Uint16.Difference(s1, s2)
		...
		s3 := Uint16.FromSlice(slice[1:])
		s4 := Uint16.FromSlice(slice)
		Uint16.Difference(s3, s4)
		...
		s5 := Uint16.FromSlice(slice[1:])
		s6 := Uint16.FromSlice(slice[:1])
		Uint16.Difference(s5, s6)
		...
		s7 := Uint16.FromSlice(slice)
		s8 := Uint16.FromSlice(slice)
		Uint16.Difference(s7, s8)
		for i, want := range []bool{false, false} {
