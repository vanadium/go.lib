...
func TestFloat64(t *testing.T) {
	...
	{
		s1 := Float64.FromSlice(slice)
		s2 := Float64.FromSlice(slice[1:])
		Float64.Difference(s1, s2)
		...
		s3 := Float64.FromSlice(slice[1:])
		s4 := Float64.FromSlice(slice)
		Float64.Difference(s3, s4)
		...
		s5 := Float64.FromSlice(slice[1:])
		s6 := Float64.FromSlice(slice[:1])
		Float64.Difference(s5, s6)
		...
		s7 := Float64.FromSlice(slice)
		s8 := Float64.FromSlice(slice)
		Float64.Difference(s7, s8)
		for i, want := range []bool{false, false} {
