...
func TestUintptr(t *testing.T) {
	...
	{
		s1 := Uintptr.FromSlice(slice)
		s2 := Uintptr.FromSlice(slice[1:])
		Uintptr.Difference(s1, s2)
		...
		s3 := Uintptr.FromSlice(slice[1:])
		s4 := Uintptr.FromSlice(slice)
		Uintptr.Difference(s3, s4)
		...
		s5 := Uintptr.FromSlice(slice[1:])
		s6 := Uintptr.FromSlice(slice[:1])
		Uintptr.Difference(s5, s6)
		...
		s7 := Uintptr.FromSlice(slice)
		s8 := Uintptr.FromSlice(slice)
		Uintptr.Difference(s7, s8)
		for i, want := range []bool{false, false} {
