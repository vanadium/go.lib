...
func TestString(t *testing.T) {
	...
	// Test set difference.
	{
		...
		s3 := String.FromSlice(slice[1:])
		s4 := String.FromSlice(slice)
		String.Difference(s3, s4)
		...
		s5 := String.FromSlice(slice[1:])
		s6 := String.FromSlice(slice[:1])
		String.Difference(s5, s6)
		...
		s7 := String.FromSlice(slice)
		s8 := String.FromSlice(slice)
		String.Difference(s7, s8)
		for i, want := range []bool{false, false} {
